      ...
      <ul>
       ...
       <li>
         ...
         <span className="icon">
          ...
          <span className="navigation_item">Admissions</span>
          </NavLink>
       </li>
       <li>
         <NavLink
         ...
         <span className="icon">
          ...
          <span className="navigation_item">Students</span>
         </NavLink>
       </li>
       <li>
          <NavLink
          className={({ isActive }) => isActive ? "activeLink" : ""}
          to='/admin/view-teachers'>
            <span className="icon">
               <FontAwesomeIcon icon={solid('chalkboard-user')} />
            </span>
            <span className="navigation_item">Teachers</span>
          </NavLink>
       </li>
       <li>
          <NavLink
          ...
          to='/admin/add-class'>
            ...
            <span className="navigation_item">Add Class</span>
          </NavLink>
       </li>
       <li>
          <NavLink
          ...
          to='/admin/register-teacher'>
            ...
            <span className="navigation_item">Register Instructor</span>
          </NavLink>
       </li>
       <li>
          <NavLink
          ...
          to='/admin/add-announcement'>
            ...
            <span className="navigation_item">Add Announcement</span>
          </NavLink>
       </li>
      </ul>
     </div>
