      ...
      <ul>
       ...
       <li>
          ...
          to='/teacher/add-assignment'>
            ...
            <span className="navigation_item">Add Assignment</span>
          </NavLink>
       </li>
       ...
       <li>
          <NavLink
          className={({ isActive }) => isActive ? "activeLink" : ""}
          to='/teacher/view-classes'>
            <span className="icon">
               <FontAwesomeIcon icon={solid('book')} />
            </span>
            <span className="navigation_item">My Classes</span>
          </NavLink>
       </li>
       <li>
          <NavLink
          ...
          to='/teacher/add-exam'>
            ...
            <span className="navigation_item">Add Exams</span>
          </NavLink>
       </li>
      </ul>
     </div>
